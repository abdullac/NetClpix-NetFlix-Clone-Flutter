...
dynamic comingsoonParentListviewWidth() => screenDimonsion(
      null,
      double.infinity,
      null,
    );
...
dynamic comingsoonImageAndDetailsWidth() => screenDimonsion(
      screenWidth() * 84 / 100,
      null,
      screenHeight() * 60 / 100,
    );
dynamic comingsoonImageAndDetailsHieght() => screenDimonsion(
      null,
      screenHeight() * 70 / 100,
      null,
    );

dynamic detailsAreaWidth() => screenDimonsion(
      null,
      screenWidth() * 24 / 100,
      null,
    );
